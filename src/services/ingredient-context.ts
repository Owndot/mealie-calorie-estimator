...
const groups: Record<string, string[]> = {
  ...
  flour: ["Mehl", "Weizenmehl", "Weizenmehl Type 405", "wheat flour", "plain flour"], sugar: ["Zucker", "sugar"],
  yeast: ["Hefe", "yeast"], "fresh yeast": ["Frische Hefe", "fresh yeast"], "dry yeast": ["Trockenhefe", "dry yeast"],
  salt: ["Salz", "Speisesalz", "Tafelsalz", "Meersalz", "sea salt", "table salt"],
